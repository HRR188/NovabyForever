<template>
    <div class="canvas-container" ref="container" id="container">
        <div ref="canvas" v-show="loadStatus.loadCom" style="height: 100%;width: 100%" id="canvas"></div>
        <btns :id="id" :showEditBtn="showEditBtn" :showAnnoBtn="showAnnoBtn" @goEdit="goEdit" @goAnno="goAnno"></btns>
        ...
        >
            ...
            <div class="annotation-desc" v-show="annotation.showDesc" v-lang.sa>
...
<script>
    ...
    export default {
        name: 'three-d-annotation',
        mixins:[initScene,annotation],
        components:{
            Loading,
            ImageUpload,
            btns
        ...
        mounted(){
            this.initCanvas();
            this.init();
            console.log(this.disableAnimate)
        },
        messages:{
            en:{
                fs:'FEEDBACK SYSTEM',
