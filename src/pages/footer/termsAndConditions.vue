<template lang="html">
    <section class="main">
        <div class="web-instructions w-940 auto">
            ...
            <div class="content">
                ...
                <p>
                    ...
                    or
                    <strong>"us"</strong>
                    means Novaby International Pty Limited.
                </p>
                <p>
                    <strong>"Novaby Verified"</strong>
                    Users have been satisfactorily verified under the Know your Customer and Identity Verification Policy.
                </p>
                <p>
                    <strong>"Inactive Account"</strong>
                    means a User Account that has not been logged into for a 6 month period, or other period determined by us from time to time.
                </p>
                <p>
                ...
                <p>
                    ...
                    means a payment made by the Buyer for the provision of Seller Services under a User Contract and which will be released in accordance with the section "Milestone Payments" of these terms and conditions.
                </p>
                <p>
                    <strong>"Project"</strong>
                    means a job offered or awarded by a Buyer via the Website, which may include a Project listed by a Buyer, a Project awarded by a Buyer (for example through HireMe), a service bought by a Buyer from a Seller, and service awarded by a Buyer to a Seller as a result of a Contest or competition hosted via the Website.
                </p>
                <p>
                    <strong>"Seller"</strong>
                    means a User that offers and provides services or identifies as a Seller through the Website. A User may be both a Buyer and a Seller under this agreement.
                </p>
                <p>
                    <strong>"Seller Services"</strong>
                    means all services provided by a Seller.
                </p>
                <p>
                    <strong>"Novaby Services"</strong>
                ...
                <p>
                    ...
                     means the Websites operated by Novaby and available at: <router-link to="/home">Novaby.com</router-link> and any of its regional or other domains or properties, and any related Novaby service, tool or application, specifically including mobile web, any iOS App and any Android App
                </p>
                <h6>1.	Overview</h6>
                <p>
                    By accessing the Website, you agree to the following terms with Novaby.
                </p>
                <p>
                ...
                <ol>
                    ...
                    <li>
                        3.	a person barred from receiving and rendering services under the laws of China and United States of America or another applicable jurisdiction;
                    </li>
                    <li>
                ...
                <ol>
                    ...
                    <li>
                        5.	circumvent or manipulate our fee structure, the billing process, or fees owed to Novaby;
                    </li>
                    <li>
                    ...
                    <li>
                        8.	transfer your Novaby account (including feedback) and Username to another party without our consent;
                    </li>
                    <li>
                        9.	distribute or post spam, unsolicited, or bulk electronic communications, chain letters, or pyramid schemes;
                    </li>
                    <li>
                        10.	distribute viruses or any other technologies that may harm Novaby, the Website, or the interests or property of Novaby users (including their Intellectual Property Rights, privacy and publicity rights) or is unlawful, threatening, abusive, defamatory, invasive of privacy, vulgar, obscene, profane or which may harass or cause distress or inconvenience to, or incite hatred of, any person;
                    </li>
                    <li>
                    ...
                    <li>
                        13.	copy, modify or distribute rights or content from the Website or Novaby's copyrights and trademarks; or
                    </li>
                    <li>
                        14.	harvest or otherwise collect information about Users, including email addresses, without their consent.
                    </li>
                </ol>
                <h6>5.	Intellectual Property Rights Infringement</h6>
                <p>
                ...
                <h6>8.	Payment Administration Agent</h6>
                <p>
                ...
                <h6>9.	Promotion</h6>
                <p>
                    We may display your company or business name, logo, images or other media as part of the Novaby Services and/or other marketing materials relating to the Website, except where you have explicitly requested that we do not do this and we have agreed to such a request in writing.
                </p>
                <p>
                ...
                <h6>11.	Feedback, Reputation and Reviews</h6>
                <p>
                ...
                <p>
                    You may not do (or omit to do) anything that may undermine the integrity of the Novaby feedback system. We are entitled to suspend or terminate your Account at any time if we, in our sole and absolute discretion, are concerned by any feedback about you, or your feedback rating, where we believe our feedback system may be subverted.
                </p>
                <p>
                    Our feedback ratings belong to us and may not be used for any purpose other than facilitating the provision of Seller Services via the Website. You may not use your Seller or Buyer feedback (including, but not limited to, marketing or exporting your any or all of your composite rating(s) or feedback comments) in any real or virtual venue other than a website operated by Novaby or its related entities, without our written permission.
                </p>
                <h6>12.	Advertising</h6>
                <p>
                ...
                <p>
                    Novaby may use information such as your name, location, display or username, and or your image, in relation to the provision messaging services on the Website or in the mobile apps.
                </p>
                <p>
                ...
                <h6>14.	Identity / Know Your Customer</h6>
                <p>
                ...
                <p>
                    We reserve the right to close, suspend, or limit access to your Account, the Website and/or Novaby Services in the event we are unable to obtain or verify to our satisfaction the information which we request under this section.
                </p>
                <p>
                ...
                <p>
                    If you are not Novaby verified you may not be able to withdraw funds from your Novaby account, and other restrictions may apply. See the Know Your Customer and Identity Verification Policy for more details.
                </p>
                <h6>15.	User Services</h6>
                <p>
                ...
                <p>
                    Each User acknowledges and agrees that the relationship between Buyers and Sellers is that of an independent contractor. Nothing in this User Agreement creates a partnership, joint venture, agency or employment relationship between Users. Nothing in this User Agreement shall in any way be construed as forming a joint venture, partnership or an employer-employee relationship between Novaby and any User.
                </p>
                <h6>16.	Special Provisions for Local Jobs</h6>
                <p>Each User acknowledges:</p>
                <ol>
                    <li>
                        1.	Novaby does not review, approve, recommend or verify any of the credentials, licenses or statements of capability in relation to Local Jobs (or, for the avoidance of doubt, any non-Local Jobs on the Website);
                    </li>
                    <li>
                        2.	Novaby provides matchmaking and platform services only. Users agree that Novaby has no liability for any other aspect of service delivery or interaction between Buyer and Seller. Novaby is not a party to any disputes between Buyer and Seller, although we provide a dispute resolution mechanism to assist the parties in resolving issues;
                    </li>
                    <li>
                        3.	Novaby may from time to time include map features and Novaby may display the location of Users to persons browsing the Website on that map. Every Buyer seeking services for Local Jobs will be asked to provide the location where the Local Job is to be performed. You expressly agree that Novaby has no liability for displaying such information.
                    </li>
                    <li>
                    ...
                    <li>
                        5.	Novaby may collect location related data from you via technologies including but not limited to GPS, IP address location, wifi, and other methods. This data may be shared in the context of facilitating services for Local Jobs and each User specifically consents to this collection and sharing as part of this agreement;
                    </li>
                    <li>
                ...
                <ol>
                    ...
                    <li>
                        2.	the funds shown in your Account (which may include Milestone Payments and/or any prepayment of fees and charges which you owe to us) represents our unsecured obligations to you with respect to your rights to direct us to make payment in relation to the purchase and sale of Seller Services through the Website and provision of the Novaby Services;
                    </li>
                    <li>
                    ...
                    <li>
                        9.	we will hold funds in respect of the amount of your Account (including Milestone Payments) in an account held by us with a financial institution (or in any manner that we decide in our sole discretion from time to time) and such funds are not segregated into a separate account; and
                    </li>
                    <li>
                        we may commingle your funds with funds of other Users and our own funds and such commingled funds could be used to pay other Users or for our general 1.	corporate purposes or otherwise, however, we will remain obliged to release or refund funds at your direction in accordance with this User Agreement.
                    </li>
                </ol>
                <h6>18.	Limits &amp; Fraud Prevention</h6>
                <p>
                ...
                <p>
                    You can request a refund by using our customer support website or emailing us at info@Novaby.com. Once you have made a milestone payment, you expressly agree to use the dispute resolution process in this agreement, expressly agree to be bound by its ruling and expressly agree not to initiate any chargeback request with your card issuer.
                </p>
                <p>
                ...
                <p>
                    We may require you to be Novaby Verified before you can withdraw funds from your Novaby account, irrespective of whether or not a delay has been enforced.
                </p>
                <p>
                ...
                <h6>23.	Right to Refuse Service</h6>
                <p>
                ...
                <p>
                    We do not operate an escrow service in relation to the Website. Novaby separately owns and operates a business known as Escrow.com - for the avoidance of doubt this business is separate and there is no connection between terms, conditions, products and services offered on Novaby and services offered on Escrow.com. We do however, provide a service on this Website which allows controlled payments to be made with respect to a service, called Milestone Payments.
                </p>
                <p>
                ...
                <h6>25.	Milestone Dispute Resolution Services</h6>
                <p>
                    Novaby offers Milestone Dispute Resolution Services to Users who have elected to use the Milestone Payment feature. You agree and acknowledge that: (i) Novaby is not providing legal services; (ii) Novaby will not advise you regarding any legal matters; and (iii) if you desire to have legal counsel, you will seek an independent legal counsel from those licensed to practice law in your jurisdiction. You will not rely on Novaby for any such counsel.
                </p>
                <p>
                    In the event of a dispute between a Buyer and a Seller regarding a return or release of Milestone Payments, either Buyer or Seller may elect to use the Milestone Dispute Resolution Services offered by Novaby as set out in the Milestone Disputes Policy. The Buyer and Seller will then be notified that the matter will be addressed through Milestone Dispute Resolution Services.
                </p>
                <p>
                    You agree to indemnify and (to the maximum extent permitted by law) hold Novaby and any of our affiliates harmless against any damages or liability you may suffer as a result of using the Milestone Payments and/or Milestone Dispute Resolution Services.
                </p>
                <p>
                    Novaby will respond to disputes initiated by a Seller or a Buyer in accordance with the Milestone Dispute Resolution Services as set out in this clause and the Milestone Disputes Policy and in relation to disputes that arise in relation to the provision of the venue, and the hosting of the Website by Novaby as set out in the clause entitled Disputes with Us, along with the approach to disclosing information in relation to chargebacks set out in clauses 19 and 21 of this agreement
                </p>
                <h6>26.	Other Disputes with Users</h6>
                <p>
                ...
                <p>
                    You agree that any dispute that is not related to a Milestone Payment (which must be dealt with in accordance with the Milestone Disputes Policy) arising between you and another User will be handled in accordance with this clause. Novaby will have full rights and powers to make a determination for all such disputes. Upon receipt of a dispute, Novaby shall have the right to request the Seller and the Buyer to provide documentation in support of their claim or position in relation to the dispute. You agree that Novaby has absolute discretion to accept or reject any document provided. You also acknowledge that Novaby is not a judicial or alternative dispute resolution institution and that we will make the determinations only as an ordinary reasonable person. In addition, we do not warrant that the documents provided by the parties to the dispute will be true, complete or correct and you agree to indemnify and (to the maximum extent permitted by law) hold Novaby and any of our affiliates harmless against any damages or liability you may suffer as a result of any documentation or material subsequently being found to be false or misleading.
                </p>
                <p>
                    In relation to disputes with any other users of the Website, you hereby agree to indemnify Novaby from any and all claims, demands, and damages, actual and consequential, of every kind and nature, known and unknown, that is related to such a dispute, our determinations or the use of the Milestone Dispute Resolution Services for Milestone Payments and/or for Other Disputes.
                </p>
                <p>
                    The Novaby Code of Conduct applies to all the services offered by Novaby, including, but not limited to, the Milestone Dispute Resolution Services. It is agreed by you that you will make every endeavour at fair play and post reasonable and fair demands/offers on your dispute. No conduct relating to threats, blackmail, intimidation or inducement of users to leave positive feedback will be tolerated, in particular any refusal to provide either deliverables or payment in relation to the provision of feedback.
                </p>
                <p>
                ...
                <h6>27.	Disputes with Us</h6>
                <p>
                    If a dispute arises between you and Novaby, our goal is to address your concerns immediately and, if we are unable to do so to your satisfaction, to provide you with a means of resolving the dispute quickly. We strongly encourage you to first contact us directly to seek a resolution by using our customer support website or emailing us at info@Novaby.com.
                </p>
                <p>
                    For any claim, Novaby may elect to resolve the dispute in a cost-effective manner through binding non-appearance-based arbitration. If Novaby elects arbitration, such arbitration will be initiated through an established alternative dispute resolution (ADR) provider, which is to be selected by you from a panel of ADR providers that Novaby will provide to you. The ADR provider and the parties must comply with the following rules: a) the arbitration shall be conducted by telephone, online and/or be solely based on written submissions, the specific manner shall be chosen by the party initiating the arbitration; b) the arbitration shall not involve any personal appearance by the parties or witnesses unless otherwise mutually agreed by the parties; and c) any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction.
                </p>
                <p>
                    All claims you bring against Novaby must be resolved in accordance with the terms of this Agreement. All claims filed or brought contrary to this Agreement shall be considered improperly filed and a breach of this Agreement. Should you file a claim contrary to the terms of this Agreement, Novaby may recover its legal fees and costs (including in-house lawyers and paralegals), provided that Novaby has notified you in writing of the improperly filed claim, and you have failed to promptly withdraw the claim.
                </p>
                <p>
                ...
                <p>
                    If any proceeding by or against you is commenced under any provision of any bankruptcy or insolvency law, Novaby will be entitled to recover all reasonable costs or expenses (including reasonable legal fees and expenses) incurred in connection with the enforcement of this Agreement.
                </p>
                <p>
                    Novaby's failure to act with respect to a breach by you or others does not waive our right to act with respect to subsequent or similar breaches.
                </p>
                <h6>28.	Currencies</h6>
                <p>
                ...
                <h6>30.	Access and Interference</h6>
                <p>
                ...
                <ol>
                    ...
                    <li>
                        3.	copy, reproduce, modify, create derivative works from, distribute, or publicly display any content (except for your information) from the websites without the prior express written permission of Novaby and the appropriate third party, as applicable;
                    </li>
                    <li>
                ...
                <h6>34.	No Warranty as to Content</h6>
                <p>
                ...
                <ol>
                    <li>
                        1.	the Website or any Seller Services or Novaby Services;
                    </li>
                    <li>
                        2.	the accuracy, reliability, availability, veracity, timeliness or content of the Website or any Seller Services or Novaby Services;
                    </li>
                    <li>
                        3.	whether the Website or Seller Services or Novaby Services will be up-to-date, uninterrupted, secure, error-free or non-misleading;
                    </li>
                    <li>
                        4.	whether defects in the Website will be corrected;
                    </li>
                    <li>
                        5.	whether the Website, the Seller Services or the Novaby Services or any data, content or material will be backed up or whether business continuity arrangements are in place in respect of the Website, Seller Services or Novaby Services;
                    </li>
                    <li>
                        6.	any third party agreements or any guarantee of business gained by you through the Website, Seller Services or Novaby Services or us; or
                    </li>
                    <li>
                        7.	the Website, Seller Services or Novaby Services or infrastructure on which they are based, being error or malicious code free, secure, confidential or performing at any particular standard or having any particular function.
                    </li>
                </ol>
                <p>
                ...
                <h6>35.	Limitation of Liability</h6>
                <p>
                ...
                <h6>43.	Additional Terms</h6>
                <p>
                    It is important to read and understand all our policies as they provide the rules for trading on the Novaby Website. In addition, there may be specific policies or rules that apply, and it is your responsibility to check our Help pages and policies to make sure you comply. Our policies, including all policies referenced in them, are part of this Agreement and provide additional terms and conditions related to specific services offered on our Websites, including but not limited to:
                </p>
                <ul>
                    <li>
                        •	Privacy Policy
                ...
                <p>
                    Each of these policies may be changed from time to time. Changes take effect when we post them on the Novaby Website. When using particular services on our Website, you are subject to any posted policies or rules applicable to services you use through the Website, which may be posted from time to time. All such policies or rules are incorporated into this User Agreement.
                </p>
                <h6>44.	General</h6>
                <p>
                    This Agreement contains the entire understanding and agreement between you and Novaby. The following Sections survive any termination of this Agreement: Fees And Services (with respect to fees owed for our services), Release, Content, No Warranty As To Content, Limitation Of Liability, Indemnity, Bar To Action, No Class Actions, Legal Limitations, and Disputes With Us.
                </p>
                <h6>45.	Abusing Novaby</h6>
                <p>
                    Novaby reserves to the greatest extent possible all rights, without limiting any other remedies, to limit, suspend or terminate our service(s) and or user account(s), suspend or ban access to our services, remove any content, and to take any and all technical or legal steps to ban users.
                </p>
                <p>
                    Without lo limiting the reasons for taking the aforementioned actions, conduct giving rise to this response could include:
                </p>
                <ol>
                    <li>
                    ...
                    <li>
                        6.	abuse or poor performance in the Preferred Novaby Program
                    </li>
                    <li>
                        7.	any attempt to use Novaby’s platform or services for any objectionable purpose
                    </li>
                </ol>
            </div>
        </div>
